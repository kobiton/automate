...
- **Devices**: list (incl. `virtualUsb: true` to find private devices ready for virtualUSB), list host machines with their virtualUSB status (`listHostingMachines`, org admins only), get status, reserve, terminate reservation
