...
| You want to debug your app on a real device attached to *your* machine — see it in `adb` / Xcode, install a local build, read logcat | `debug-device-over-vusb` |
